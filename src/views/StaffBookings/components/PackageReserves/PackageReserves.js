...
const PackageReserves = (props) => {
  ...
  const handlePageChange = (event, page) => {
    getStaffReserves(package_id , page + 1);
  };
  ...
  React.useEffect(() => {
    getStaffReserves(package_id);
  } , [])
  
  const getStaffReserves = (staffPackageId,page) => {
      setLoading(true);
    axios.get(`api/staff/reserves/${staffPackageId}` , {params : {page : page}}).then(res =>{
                        ...
                        >
                            ...
                            <TableCell>
                                <Button
                                    ...
                                    to={window.dashboard_url + "/staffBooking/"+mPakcage.staff_package_id+"/reserve/"+mPakcage.id}
                                >
...
export default PackageReserves;
