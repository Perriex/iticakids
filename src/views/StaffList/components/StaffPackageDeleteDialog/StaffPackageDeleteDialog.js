...
const StaffPackageDeleteDialog = props => {

    
    const { openDialog , onDialogClosed , current_staff_package} = props;
...
export default StaffPackageDeleteDialog;
