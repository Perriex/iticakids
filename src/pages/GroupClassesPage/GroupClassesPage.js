...
import classes from './GroupClassesPage.module.scss';
...
const GroupClassesPage = props => {
    ...
    React.useEffect(() => {
        setLoading(true);
        axios.get('/api/v1.0/workshops?group_class=true').then(res => {
    ...
    return (
        <div className={classes.wrapper}>
            ...
            <div style={{
                ...
                <WorkshopCards alignLeft baseUrl={'/groupClasses'} items={categories}/>
                {
                    !loading && (
                        <Pagination
